    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
                ...
                <div id ="accordion">
                <!-- 会议室管理折叠 -->
                <div class="meun-title"  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseMeeting" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <div role="tabpanel" class="tab-pane" id="addRoomPane">
                        ...
                        <div class="data-div">
							...
							<table class = "table" id = "addRoomTable">
							   <caption><div align="center" class="text-success" id = "teachTableTip">会议室信息</div></caption>
                                		...
                                		<div class="container-fluid">
                                    		<form class="form-horizontal">
                                        		<div class="form-group ">
                                            		...
                                            		<div class="col-xs-6 ">
                                                		<input type="text" class="form-control input-sm duiqi" id="roomNumberInput" placeholder="">
                                            		</div>
                                        		</div>
                                        		<div class="form-group ">
                                            		<label for="capabilityInput" class="col-xs-3 control-label">容纳人数：</label>
                                            		<div class="col-xs-6 ">
                                                		<input type="text" class="form-control input-sm duiqi" id="capabilityInput" placeholder="">
                                            		</div>
                                        		</div>
                                    		</form>
                                		</div>
