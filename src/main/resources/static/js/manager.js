...
$(document).ready(function(){
	...
	/*//新增一个空闲时间输入form
	$(".addFreePane").click(function(){
		
		alert("+键被点击了");
		var form = '<form class="form-horizontal"  onsubmit="return false;">' +
		'<div class="form-group "> '+
    		'<label  class="col-xs-3 control-label">开始日期：</label>'+
    		'<div class="col-xs-6 ">'+
        		'<input type="text" class="form-control input-sm duiqi startDate"  placeholder="">'+
    		'</div>'+
		'</div>'+
		'<div class="form-group ">'+
    		'<label  class="col-xs-3 control-label">结束日期：</label>'+
    		'<div class="col-xs-6 ">'+
        		'<input type="text" class="form-control input-sm duiqi"  placeholder="">'+
    		'</div>'+
		'</div>'+
		'<div class="form-group ">'+
    		'<label  class="col-xs-3 control-label">开始时间：</label>'+
